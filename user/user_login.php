...
<body>
    ...
    <div class="container-fluid p-0">
                ...
                <div class="col-lg-10 col-xl-6">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-outline">
                            ...
                            <input type="text" id="username" class="form-control mb-2 mt-2" placeholder="Enter your username" required name="username">
                        </div>
                        <div class="form-outline">
                            <!-- password field -->
                        ...
                        <div class="mb-5 pb-5  mt-3">
                            <p class="small"><a href="" class="text-decoration-underline">Forgot password</a></p>
                            <input type="submit" value="Login" class="bg-primary py-2 px-3 border-0 mb-2" name="user_login">
                            <p class="small font-weight-bold mb-">Dont't have a account? <a href="user_registration.php" class="text-info"> Register</a></p>
                        </div>
        ...
        <!-- last child -->
        <div class="bg-secondary p-3 text-center mt-5">
