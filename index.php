...
<body>
    ...
    <div class="container-fluid p-0">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search" action="" method="get">
                        ...
                        <input class="form-control me-2" type="search" name="search_data" placeholder=" Search Patients " aria-label="Search">
        ...
        <!-- second child -->
        <div class="nav navbar navbar-expand-lg navbar-dark bg-secondary left">
            ...
            <ul class="nav-bar nav ul-list">
                <li class="nav-item">
                    <!-- <a href="./admin/admin_login.php" class="nav-link text-dark">Admin Login <i class='fa fa-sign-in' aria-hidden='true'></i></a> -->
                    <a href="./admin/admin_login.php" class="nav-link text-dark"> Doctor Login <i class='fa fa-sign-in' aria-hidden='true'></i></a>
                </li>
            </ul>
        </div>
